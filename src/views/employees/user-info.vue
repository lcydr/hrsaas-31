  ...
  <div class="user-info">
    ...
    <el-form label-width="220px">
      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <!-- 放置上传图片 -->
            <uploadimg ref="headerimg" @onSuccess="headerimgonSuccess" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
      <el-row class="inline-info" type="flex" justify="center">
        <el-col :span="12">
          <el-button type="primary" @click="info1list">保存更新</el-button>
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <uploadimg ref="employeesimg" @onSuccess="employeesimgonSuccess" />
        </el-form-item>
      ...
      <div class="block">
        ...
        <el-row class="inline-info" type="flex" justify="center">
          <el-col :span="12">
            <el-button type="primary" @click="fuzainfolist">保存更新</el-button>
            <el-button @click="$router.back()">返回</el-button>
          </el-col>
        </el-row>
      </div>
...
import { getuserinfoxq, putinfolist, updatePersonal } from '@/api/user'
...
export default {
  ...
  methods: {
    //数据回显资料
    async getuserinfoxq() {
      const res = await getuserinfoxq(this.userId)
      this.userInfo = res
    ...
    //点击上传保存资料
    async info1list() {
      await putinfolist(this.userInfo)
      if (this.$refs.headerimg.loading) {
        return this.$message.success('头像正在上传中')
      }
